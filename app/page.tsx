...
/>
        ...
        <div className="flex items-center justify-center p-6 md:w-3/5 md:px-28 md:py-12">
          ...
          <Image src="/hero-desktop.png" width={1000} height={760} className="hidden md:block" alt="creenshots of the dashboard project showing desktop version" />
          <Image src="/hero-mobile.png" width={560} height={620} className="block md:hidden" alt="creenshots of the dashboard project showing mobile version"/>
        </div>
      </div>
    </main>
  );
